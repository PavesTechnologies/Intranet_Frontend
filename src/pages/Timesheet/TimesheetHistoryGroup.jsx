          ...
          {weekData.timesheets
            ...
            .map((timesheet, index) => (
              ...
              >
                ...
                <div
                  className={`${formatDate(timesheet.workDate).isWeekend ? "bg-yellow-100 cursor-not-allowed" : timesheet.defaultHolidayTimesheet ? "bg-red-200 cursor-not-allowed" : ""} border-b-2 border-gray-300 px-4 py-3 flex justify-between items-center rounded-t-lg overflow-visible`}
                >
                                   {" "}
