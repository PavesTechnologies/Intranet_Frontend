...
import { FolderKanban, FileText, Cable, PenLine, CheckCircle2, ArrowRight, History } from "lucide-react";
      ...
      <PageCard>
        <PageCardContent className="p-4 sm:p-5">
          <div className="mb-3 flex items-center justify-between">
            ...
            <Button variant="link" size="small" onClick={() => navigate(OVERVIEW_PATH)} className="gap-1">
              View all
