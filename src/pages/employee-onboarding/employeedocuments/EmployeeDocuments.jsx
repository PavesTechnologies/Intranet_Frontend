    ...
    return (
      <div className="min-h-screen bg-zinc-50 p-4 sm:p-6 lg:p-8 flex items-center justify-center font-sans">
        <div className="flex flex-col items-center gap-4 bg-white p-8 rounded-3xl shadow-sm border border-red-100 max-w-md text-center">
          ...
          <button
            className="mt-4 px-4 py-2 bg-violet-50 text-violet-600 font-semibold rounded-lg hover:bg-violet-100 transition-colors"
            ...
            <div className="relative z-10 flex flex-col justify-between gap-6 md:flex-row md:items-end">
              <div>
                ...
                <p className="mt-3 flex items-center gap-2 text-sm text-zinc-500 max-w-xl">
                  ...
                  Manage, verify, and seamlessly organize essential documents
                    ...
                    <div className="space-y-5 p-4 sm:p-6">
                      {visibleEmployees.map((emp) => {
                        ...
                        return (
                          <div
                            key={emp.id}
                            className={`overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-zinc-200 transition-all duration-300 ${
                              isExpanded
                                ? "shadow-lg ring-violet-100/50"
                                : "hover:shadow-md hover:ring-zinc-300"
                            }`}
                          >
                            <div
                            ...
                            >
                              ...
                              <div className="flex items-center gap-5">
                                ...
                                <div
                                  className={`flex h-8 w-8 items-center justify-center rounded-full transition-colors ${isExpanded ? "bg-violet-50 text-violet-600" : "bg-zinc-50 text-zinc-400 group-hover:bg-zinc-100"}`}
                                >
                                  {isExpanded ? (
                                    ...
                                    <table className="w-full text-left text-sm whitespace-nowrap">
                                      <thead>
                                        <tr className="border-b border-zinc-200 text-xs font-semibold uppercase tracking-wider text-zinc-500">
                                          ...
                                          <th
                                            scope="col"
                                            className="pb-3 pl-4 pr-2 text-right"
                                          >
                                            Actions
                                          </th>
                                        </tr>
                                        ...
                                        {documentsToShow.map((doc) => (
                                          ...
                                          >
                                            ...
                                            <td className="px-4 py-4">
                                              <span
                                                className={`inline-flex items-center rounded-full border px-2.5 py-1 text-xs font-semibold tracking-wide ${getStatusBadge(doc.status)}`}
                                              >
