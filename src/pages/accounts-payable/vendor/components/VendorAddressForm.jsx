 ...
 *
 * `variant="intake"` renders the same address fields for the Register Vendor
 * (Vendor Intake) flow, where POST /apm/vendor-intake takes a single flat address
 * and no address_type/is_primary/per-address country, and the page already has its
 * own GST verification block — so those four controls are hidden. The default
 * variant is unchanged for the vendor detail Addresses tab.
 */
const VendorAddressForm = ({ formData, errors = {}, onChange, variant = "full" }) => {
