...
/** Route: /accounts-payable/vendors/:vendorId */
export default function VendorDetailPage() {
  ...
  const handleConfirmStatusChange = async () => {
    try {
      ...
      toast.success(confirmStatusChange === "activate" ? "Vendor activated." : "Vendor deactivated.");
        ...
        actions={
          canEditVendor ? (
            <div className="flex gap-2">
              <Button variant="outline" onClick={() => navigate(AP_ROUTES.VENDOR_UPDATE(vendorId))}>
          ...
          <PageCard>
            <PageCardContent>
              <div className="grid grid-cols-1 gap-x-8 gap-y-1 md:grid-cols-2">
                ...
                <DetailRow label="Last Updated" value={formatDate(vendor.updated_at)} />
              </div>
            </PageCardContent>
          </PageCard>
        )}
