// src/components/MyWork/FilterBar.jsx
import React, { useState, useRef, useEffect } from "react";
import { ChevronDown, X, SlidersHorizontal } from "lucide-react";
import { useMyWorkStore } from "../../pages/Projects/MyWork/hooks/myWorkStore";
import { TYPE_CONFIG, PRIORITY_CONFIG } from "../../pages/Projects/MyWork/utils/myWorkUtils";
...
export default function FilterBar({ projects }) {
  ...
  return (
    <div className="flex items-center gap-2 mb-5 flex-wrap">
      <div className="flex items-center gap-0.5 p-0.5 bg-slate-100 rounded-lg mr-1">
        <button
